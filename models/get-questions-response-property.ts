 ...
 * 
 * @export
 * @interface GetQuestionsResponseProperty
 */
export interface GetQuestionsResponseProperty {
    /**
     * 
     * @type {Array<QuestionDefinition>}
     * @memberof GetQuestionsResponseProperty
     */
    'elements': Array<QuestionDefinition>;
}
