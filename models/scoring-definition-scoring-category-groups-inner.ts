 ...
 * 
 * @export
 * @interface ScoringDefinitionScoringCategoryGroupsInner
 */
export interface ScoringDefinitionScoringCategoryGroupsInner {
    [key: string]: any;

    /**
     * The scoring categories.
     * @type {Array<string>}
     * @memberof ScoringDefinitionScoringCategoryGroupsInner
     */
    'Categories': Array<string>;
    /**
     * The unique identifier for the scoring group.
     * @type {string}
     * @memberof ScoringDefinitionScoringCategoryGroupsInner
     */
    'ID': string;
    /**
     * The names of the scoring category groups.
     * @type {string}
     * @memberof ScoringDefinitionScoringCategoryGroupsInner
     */
    'Name': string;
