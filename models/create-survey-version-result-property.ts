 ...
 * 
 * @export
 * @interface CreateSurveyVersionResultProperty
 */
export interface CreateSurveyVersionResultProperty {
    /**
     * 
     * @type {SurveyVersionMetadata}
     * @memberof CreateSurveyVersionResultProperty
     */
    'metadata': SurveyVersionMetadata;
}
