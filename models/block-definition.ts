...
import { ConjointBlock } from './conjoint-block';
import { LibraryID } from './library-id';
import { ReferenceBlock } from './reference-block';
import { StandardBlock } from './standard-block';
import { TrashBlock } from './trash-block';

/**
 * @type BlockDefinition
 * @export
 */
export type BlockDefinition = ReferenceBlock | StandardBlock | TrashBlock | ConjointBlock;
