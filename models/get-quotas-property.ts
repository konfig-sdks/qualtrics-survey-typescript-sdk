 ...
 * 
 * @export
 * @interface GetQuotasProperty
 */
export interface GetQuotasProperty {
    /**
     * 
     * @type {Array<Quota>}
     * @memberof GetQuotasProperty
     */
    'elements': Array<Quota>;
    /**
     * A URL with the parameters required to access the next page of quotas.
     * @type {string}
     * @memberof GetQuotasProperty
     */
    'nextPage'?: string;
