...
import { SurveyVersionMetadata } from './survey-version-metadata';

/**
 * 
 * @export
 * @interface ListSurveyVersionsResponseResult
 */
export interface ListSurveyVersionsResponseResult {
    /**
     * 
     * @type {Array<SurveyVersionMetadata>}
     * @memberof ListSurveyVersionsResponseResult
     */
    'elements': Array<SurveyVersionMetadata>;
}
