 ...
 * Object.
 * @export
 * @interface AuthenticatorFlowElementSSOOptionsRespondentMapInner
 */
export interface AuthenticatorFlowElementSSOOptionsRespondentMapInner {
    [key: string]: any;

    /**
     * A unique identifier for a `value`.
     * @type {string}
     * @memberof AuthenticatorFlowElementSSOOptionsRespondentMapInner
     */
    'key'?: string;
    /**
