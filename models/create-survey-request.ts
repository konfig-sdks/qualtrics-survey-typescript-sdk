...
import { CreateNewSurveyRequest } from './create-new-survey-request';
import { LanguageCode } from './language-code';
import { ProjectCategory } from './project-category';
import { SurveyMetadata } from './survey-metadata';
import { SurveyQSF } from './survey-qsf';

/**
 * @type CreateSurveyRequest
 * @export
 */
export type CreateSurveyRequest = CreateNewSurveyRequest | SurveyQSF;
