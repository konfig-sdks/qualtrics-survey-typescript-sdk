 ...
 * @enum {string}
 */
export type QuestionType = 'MC' | 'Matrix' | 'Captcha' | 'CS' | 'DB' | 'DD' | 'Draw' | 'DynamicMatrix' | 'FileUpload' | 'GAP' | 'HeatMap' | 'HL' | 'HotSpot' | 'Meta' | 'PGR' | 'RO' | 'SBS' | 'Slider' | 'SS' | 'TE' | 'Timing' | 'TreeSelect'
