 ...
 * 
 * @export
 * @interface CustomLanguagesValue
 */
export interface CustomLanguagesValue {
    /**
     * Name of the custom language
     * @type {string}
     * @memberof CustomLanguagesValue
     */
    'DisplayName': string;
    /**
     * Base language for the custom language
     * @type {string}
     * @memberof CustomLanguagesValue
     */
