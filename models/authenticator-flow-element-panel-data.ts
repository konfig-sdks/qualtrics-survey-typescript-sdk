 ...
 * 
 * @export
 * @interface AuthenticatorFlowElementPanelData
 */
export interface AuthenticatorFlowElementPanelData {
    [key: string]: any;

    /**
     * The unique identifier for a specific user.
     * @type {string}
     * @memberof AuthenticatorFlowElementPanelData
     */
    'LibraryID'?: string;
    /**
     ...
     * @memberof AuthenticatorFlowElementPanelData
     */
    'Type'?: AuthenticatorFlowElementPanelDataTypeEnum;
    /**
     * Logic type.
     * @type {string}
     * @memberof AuthenticatorFlowElementPanelData
     */
    'LogicType'?: AuthenticatorFlowElementPanelDataLogicTypeEnum;
}

type AuthenticatorFlowElementPanelDataTypeEnum = 'Expression'
type AuthenticatorFlowElementPanelDataLogicTypeEnum = 'Panel'
