...
import { RandomizationElementOneOf } from './randomization-element-one-of';

/**
 * @type RandomizationElement
 ...
 * @export
 */
export type RandomizationElement = RandomizationElementOneOf | string;
