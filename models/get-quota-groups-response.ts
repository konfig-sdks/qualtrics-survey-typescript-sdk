...
import { GetQuotaGroupsProperty } from './get-quota-groups-property';
import { SuccessfulMeta } from './successful-meta';

/**
 * 
 * @export
 * @interface GetQuotaGroupsResponse
 */
export interface GetQuotaGroupsResponse {
    /**
     * 
     * @type {SuccessfulMeta}
     * @memberof GetQuotaGroupsResponse
     */
    'meta': SuccessfulMeta;
    /**
     * 
     * @type {GetQuotaGroupsProperty}
     * @memberof GetQuotaGroupsResponse
     */
    'result': GetQuotaGroupsProperty;
}
