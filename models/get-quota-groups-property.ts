...
import { QuotaGroup } from './quota-group';

/**
 * 
 * @export
 * @interface GetQuotaGroupsProperty
 */
export interface GetQuotaGroupsProperty {
    /**
     * 
     * @type {Array<QuotaGroup>}
     * @memberof GetQuotaGroupsProperty
     */
    'elements': Array<QuotaGroup>;
    /**
