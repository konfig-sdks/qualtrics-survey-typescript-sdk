 ...
 * 
 * @export
 * @interface ProjectInfoDefinitionContentBundle
 */
export interface ProjectInfoDefinitionContentBundle {
    [key: string]: any;

    /**
     * 
     * @type {string}
     * @memberof ProjectInfoDefinitionContentBundle
     */
     ...
     * @memberof ProjectInfoDefinitionContentBundle
     */
    'SurveyInputVariables': Array<{ [key: string]: any; }>;
}
