...
import { CreateSurveyVersionResultProperty } from './create-survey-version-result-property';
import { SuccessfulMeta } from './successful-meta';

/**
 * 
 * @export
 * @interface CreateSurveyVersionResponse
 */
export interface CreateSurveyVersionResponse {
    /**
     * 
     * @type {SuccessfulMeta}
     * @memberof CreateSurveyVersionResponse
     */
    'meta': SuccessfulMeta;
    /**
     * 
     * @type {CreateSurveyVersionResultProperty}
     * @memberof CreateSurveyVersionResponse
     */
    'result': CreateSurveyVersionResultProperty;
}
