...
import { AuthenticatorMessageSystemMessage } from './authenticator-message-system-message';
 ...
 */
export interface AuthenticatorMessage {
    [key: string]: any;

    /**
     * 
     * @type {AuthenticatorMessageSystemMessage}
     * @memberof AuthenticatorMessage
     */
    'SystemMessage'?: AuthenticatorMessageSystemMessage;
}
