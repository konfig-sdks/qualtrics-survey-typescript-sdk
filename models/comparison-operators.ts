 ...
 * @enum {string}
 */
export type ComparisonOperators = 'EqualTo' | 'NotEqualTo' | 'Empty' | 'NotEmpty' | 'GreaterThan' | 'GreaterThanOrEqual' | 'LessThan' | 'LessThanOrEqual' | 'Contains' | 'DoesNotContain' | 'MatchesRegex' | 'Is' | 'IsNot' | 'In' | 'InOrBelow' | 'SameAsSubject'
