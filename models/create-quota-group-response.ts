...
import { CreateQuotaGroupResultProperty } from './create-quota-group-result-property';
import { SuccessfulMeta } from './successful-meta';

/**
 * 
 * @export
 * @interface CreateQuotaGroupResponse
 */
export interface CreateQuotaGroupResponse {
    /**
     * 
     * @type {SuccessfulMeta}
     * @memberof CreateQuotaGroupResponse
     */
    'meta': SuccessfulMeta;
    /**
     * 
     * @type {CreateQuotaGroupResultProperty}
     * @memberof CreateQuotaGroupResponse
     */
    'result': CreateQuotaGroupResultProperty;
}
