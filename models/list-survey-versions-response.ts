...
import { ListSurveyVersionsResponseResult } from './list-survey-versions-response-result';
import { SuccessfulMeta } from './successful-meta';

/**
 * 
 * @export
 * @interface ListSurveyVersionsResponse
 */
export interface ListSurveyVersionsResponse {
    /**
     * 
     * @type {SuccessfulMeta}
     * @memberof ListSurveyVersionsResponse
     */
    'meta': SuccessfulMeta;
    /**
     * 
     * @type {ListSurveyVersionsResponseResult}
     * @memberof ListSurveyVersionsResponse
     */
    'result': ListSurveyVersionsResponseResult;
}
