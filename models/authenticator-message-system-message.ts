 ...
 * System message.
 * @export
 * @interface AuthenticatorMessageSystemMessage
 */
export interface AuthenticatorMessageSystemMessage {
    [key: string]: any;

    /**
     * Section of system message.
     * @type {string}
     * @memberof AuthenticatorMessageSystemMessage
     */
    'Section'?: AuthenticatorMessageSystemMessageSectionEnum;
    /**
     * System message.
     * @type {string}
     * @memberof AuthenticatorMessageSystemMessage
...
type AuthenticatorMessageSystemMessageSectionEnum = 'ErrorCodes'
