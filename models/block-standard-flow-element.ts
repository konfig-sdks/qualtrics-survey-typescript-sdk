...
/**
 * Block standard flow element.
 * @export
 * @interface BlockStandardFlowElement
 */
export interface BlockStandardFlowElement {
    [key: string]: any;

    /**
     * The ID of the survey\'s default block.
     * @type {string}
     * @memberof BlockStandardFlowElement
     */
    'ID'?: string;
    /**
     * The type of block.
     ...
     * @memberof BlockStandardFlowElement
     */
    'Type'?: BlockStandardFlowElementTypeEnum;
    /**
...
type BlockStandardFlowElementTypeEnum = 'Block' | 'Standard'
