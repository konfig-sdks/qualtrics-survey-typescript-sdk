...
import { CreateSurveyResultProperty } from './create-survey-result-property';
...
export interface CreateSurveyResponse {
    /**
     * 
     * @type {CreateSurveyResultProperty}
     * @memberof CreateSurveyResponse
     */
    'result': CreateSurveyResultProperty;
    /**
     * 
     * @type {SuccessfulMeta}
     * @memberof CreateSurveyResponse
