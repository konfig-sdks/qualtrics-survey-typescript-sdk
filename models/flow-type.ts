 ...
 * @enum {string}
 */
export type FlowType = 'Authenticator' | 'Block' | 'BlockRandomizer' | 'Branch' | 'Conjoint' | 'EmbeddedData' | 'EndSurvey' | 'Group' | 'QuotaCheck' | 'ReferenceSurvey' | 'Root' | 'Standard' | 'SupplementalData' | 'TableOfContents' | 'WebService'
