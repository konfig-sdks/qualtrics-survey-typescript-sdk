 ...
 * Visibility of data.
 * @export
 * @interface EmbeddedDataFlowElementEmbeddedDataInnerDataVisibility
 */
export interface EmbeddedDataFlowElementEmbeddedDataInnerDataVisibility {
    /**
     * If true, data is private.
     * @type {boolean}
     * @memberof EmbeddedDataFlowElementEmbeddedDataInnerDataVisibility
     */
    'Private'?: boolean;
    /**
     * If true, data is hidden.
     * @type {boolean}
     * @memberof EmbeddedDataFlowElementEmbeddedDataInnerDataVisibility
     */
    'Hidden'?: boolean;
